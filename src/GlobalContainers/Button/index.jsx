...
export const Button = (props) => {
  const { contents, weight, width, topMargin, bottomMargin,margin, color, bgColor} = props
 return(
  <BtnWrapper weight={weight} width={width} topMargin={topMargin} bgColor={bgColor} color={color}  margin={margin} bottomMargin={bottomMargin}>
 {contents}
  </BtnWrapper>
 )
}
